    ...
    <div class="card card-dark">
      <div class="card-header">
        ...
        <div class="card-tools">
          <a href="/kategori/add" type="button" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>Tambah
          </a>
        </div>
        <!-- /.card-tools -->
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-danger">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <a href="/kategori/delete/{{ $data->id_kategori }}" type="button" class="btn btn-outline-light">Hapus</a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
